...
namespace Starblast.Tentacles
{
    ...
    {
        public SerializedProperty debugOutline;
        public SerializedProperty debugTriangles;
        public SerializedProperty debugUVs;
        ...
        public void DrawControls()
        {
            ...
            EditorGUILayout.PropertyField(debugTriangles,
                new GUIContent("Final mesh", "Show triangles and outline used to build the mesh."));
            EditorGUILayout.PropertyField(debugUVs,
                new GUIContent("Draw UVs", "Show UVs created for the mesh (at the center of the scene)."));
            DrawHierarchyType();
        }
